...
namespace ControlApp.Entities.Objects
{
    public class Stock : BaseEntity
    {
        ...
        public Stock(int pId_Stock, int pId_Product, int pStock_Initial_Quantity, int pStock_Adjustment,
            bool? pState, string pCreateBy, string pUpdateBy, DateTime pCreateDate, 
        ...
        public Stock(int pId_Stock, string pName_Product, int pStock_Initial_Quantity, int pStock_Adjustment,
            bool? pState, string pCreateBy, string pUpdateBy, DateTime pCreateDate,
            DateTime? pUpdateDate)
        {
            this.Id_Stock = pId_Stock;
