...
namespace ControlApp.Entities.Objects
{
    public class Price_tags
    {
        ...
        public Price_tags(int pID_Price_Tag, decimal pTotal_Price, string pDescrip_Price, string pPrice_Tag_State)
        {
            this.ID_Price_Tag = 0;
            this.Total_Price = 0;
        ...
        public Price_tags(int pID_Price_Tag, decimal pTotal_Price, string pDescrip_Price)
        {
            this.ID_Price_Tag = 0;
            this.Total_Price = 0;
            this.Descrip_Price = null;
